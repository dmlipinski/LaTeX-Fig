...
latex_fig( 1, 'outfile1','-pdf','-png','-jpg','-tiff','-eps', ...
           '-transparent',...
           '-rasterize', h, ...
           '-r150', ...
...
latex_fig( 2, 'outfile2','-pdf','-png','-jpg','-tiff','-eps', ...
...
latex_fig( 3, 'outfile3','-pdf','-png','-jpg','-tiff','-eps', ...
...
latex_fig( 4, 'outfile4','-pdf','-png','-jpg','-tiff','-eps', ...
           '-rasterize', h, ...
           '-r150', ...
           '-latexpackages', {'\usepackage{amssymb}','\usepackage{ar}'} )
